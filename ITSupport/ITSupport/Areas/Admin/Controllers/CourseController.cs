...
namespace ITSupport.Areas.Admin.Controllers
{
    public class CourseController : Controller
    {
        ...
        public ActionResult Create(Course course, FormCollection f, HttpPostedFileBase fFileUpload)
        {
            ...
            else
            {
                if (ModelState.IsValid)
                {
                    ...
                    course.Saleprice = decimal.Parse(f["mGiaBan"]);
                    course.IDToppic = int.Parse(f["IDTopic"]);
        ...
        public ActionResult Edit(int id)
        {
            ...
            ViewBag.MaCD = new SelectList(data.Topic.ToList().OrderBy(n => n.NameTopic), "IDTopic", "NameTopic", course.IDToppic);
        ...
        public ActionResult Edit(FormCollection f, HttpPostedFileBase fFileUpload)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                course.Saleprice = decimal.Parse(f["mGiaBan"]);
                course.IDToppic = int.Parse(f["MaCD"]);
